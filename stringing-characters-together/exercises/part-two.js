...
dnaTwoAltered = dnaTwo.replace("GCT", "AGG");
...
if(typeof (dnaTwo.indexOf("CAT")) >=0 ) {
...
console.log(dnaTwoAltered.slice(16,19));

//4) Use a template literal to print, "The DNA strand is ___ characters long."

console.log(`The DNA strand is ${dnaTwoAltered.length} long.`);
